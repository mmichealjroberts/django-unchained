...
from djangounchained.middleware.compat import MiddlewareMixin
from djangounchained.middleware.conf import conf
from djangounchained.middleware.signals import check_request_enabled
...
class CrossOriginResourceSharingPostCsrfMiddleware(MiddlewareMixin):
